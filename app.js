...
const defaultProducts = [
  {
    ...
    description:
      "Premium cotton oversized T-shirt with a comfortable streetwear fit."
  },

  {
    ...
    description:
      "Clean premium white T-shirt made for everyday style."
  },

  {
    ...
    description:
      "Warm and stylish streetwear hoodie."
  },

  {
    ...
    description:
      "Classic blue jeans for everyday wear."
  },
...
let cart = JSON.parse(
  localStorage.getItem("dady_cart") || "[]"
);
      ...
      <article class="product">
        ...
        ">
          ...
          <img
            ...
            onerror="
              this.src='https://via.placeholder.com/800x1000?text=DADY+CLOTHES'
            "
  ...
  cat.innerHTML =
    categories.map(category => {
      ...
      return `
        <button
          type="button"
          onclick="filterCategory('${safeCategory}')"
        >
          ${safeCategory}
        </button>
      `;
    ...
    cart.map(item => `
      ...
      <div class="cart-item">
        ...
        <img
          ...
          onerror="
            this.src='https://via.placeholder.com/200x250?text=DADY'
          "
        >
